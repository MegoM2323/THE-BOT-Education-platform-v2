...
export const LessonCreateModal = ({
  ...
  const loadStudentsAndCredits = async () => {
    try {
      ...
      if (
        creditsResponse &&
        creditsResponse.balances &&
        Array.isArray(creditsResponse.balances)
      ) {
  ...
  const validateForm = () => {
    ...
    if (
      formData.credits_cost === undefined ||
      formData.credits_cost === null ||
  ...
  const isStudentLimitExceeded =
    selectedStudentIds.length > formData.max_students;
  ...
  const handleCreateLesson = async () => {
    ...
    try {
      ...
      const startDateTime = new Date(
        `${formData.lesson_date}T${formData.start_time}:00`,
      );
      const startDateTimeISO = startDateTime.toISOString();

      const endDateTime = new Date(
        `${formData.lesson_date}T${formData.end_time}:00`,
      );
            ...
            <form data-testid="lesson-create-form">
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  />
                  {errors.lesson_date && (
                    <span className="form-error">{errors.lesson_date}</span>
                  )}
                </div>
              </div>
              ...
              <div className="form-row">
                <div className="form-group">
                  ...
                  />
                  {errors.max_students && (
                    <span className="form-error">{errors.max_students}</span>
                  )}
                </div>
                ...
                <div className="form-group">
                  ...
                  />
                  {errors.credits_cost && (
                    <span className="form-error">{errors.credits_cost}</span>
                  )}
                </div>
              </div>
          ...
          <section className="lesson-create-section">
            ...
            {isStudentLimitExceeded && (
              <div className="form-error" style={{ marginTop: "8px" }}>
                Выбрано студентов ({selectedStudentIds.length}) больше, чем
                максимум ({formData.max_students})
              </div>
            )}
            <small className="form-hint">
